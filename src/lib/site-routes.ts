export const siteRoutes = {
  home: "/",
  category: "/category",
  popularProducts: "/category/popular-products",
  login: "/login",
  cart: "https://wp.joheiewisepro.com/cart/",
  wpAccount: "https://wp.joheiewisepro.com/my-account/",
  wpLogin: "https://wp.joheiewisepro.com/wp-login.php",
  wpLostPassword: "https://wp.joheiewisepro.com/wp-login.php?action=lostpassword",
  product: "/product",
  electricalOffers: "/special-offers/electrical-offers/c9500190102",
  about: "/business",
...
const routeByLabel = new Map<string, string>([
  ...
  ["My Joheiewisepro", siteRoutes.login],
  ["Our stores", siteRoutes.popularProducts],
  ["Stores", siteRoutes.popularProducts],
  ["Basket", siteRoutes.cart],
  ...
  ["Electrical offers", siteRoutes.electricalOffers],
