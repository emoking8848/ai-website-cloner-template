...
const targetUrl = "https://www.johnlewis.com/customer-services/shopping-with-us/privacy-notice";
const siteOrigin = "https://www.johnlewis.com";
const rootDir = process.cwd();
const researchDir = path.join(rootDir, "docs", "research", "johnlewis.com");
const sourcePath = path.join(researchDir, "privacy-notice.html");
const outputPath = path.join(rootDir, "public", "johnlewis-privacy-notice-archive.html");
